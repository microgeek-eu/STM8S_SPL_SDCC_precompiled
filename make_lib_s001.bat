@echo off
set CC_FLAGS=-mstm8 -lstm8 --std-c11 --opt-code-size --vc -DSTM8S001
...
echo Create library for STM8S001...
del stm8s001.lib
sdar -rc stm8s001.lib stm8s_adc1.rel stm8s_awu.rel stm8s_beep.rel stm8s_clk.rel stm8s_exti.rel stm8s_flash.rel stm8s_gpio.rel stm8s_i2c.rel stm8s_itc.rel stm8s_iwdg.rel stm8s_rst.rel stm8s_spi.rel stm8s_tim1.rel stm8s_tim2.rel stm8s_tim4.rel stm8s_uart1.rel stm8s_wwdg.rel
